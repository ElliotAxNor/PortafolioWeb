        ...
        <section id="About-me" className="section-container">
            ...
            <div className="aboutme-body">
                ...
                <div className="photo-container">
                    ...
                    <img srcSet="src/assets/foto.webp" type="image/webp" alt="Foto"/>
                </div>
            </div>
            <h2>Skills</h2>
            <div className="skills-container">
                <div className="skills-category">
                    ...
                    <div className="skills">
                        <img src="src/assets/Icons/HTML5.svg" title="HTML5" alt="HTML5" />
                        <img src="src/assets/Icons/CSS3.svg" title="CSS3" alt="CSS3" />
                        <img src="src/assets/Icons/JavaScript.svg" title="JavaScript" alt="JavaScript" />
                        <img src="src/assets/Icons/React.svg" title="React" alt="React" />
                        <img src="src/assets/Icons/Tailwind CSS.svg" title="Tailwind CSS" alt="Tailwind CSS" />
                        <img src="src/assets/Icons/Bootstrap.svg" title="Bootstrap" alt="Bootstrap" />
                    </div>
                </div>
                <div className="skills-category">
                    <h3>Backend</h3>
                    <div className="skills">
                        <img src="src/assets/Icons/Python.svg" title="Python" alt="Python" />
                        <img src="src/assets/Icons/Django.svg" title="Django" alt="Django" />
                        <img src="src/assets/Icons/Java.svg" title="Java" alt="Java" />
                    </div>
                </div>
                <div className="skills-category">
                    <h3>Tools</h3>
                    <div className="skills">
                        <img src="src/assets/Icons/Docker.svg" title="Docker" alt="Docker" />
                        <img src="src/assets/Icons/Git.svg" title="Git" alt="Git" />
                        <img src="src/assets/Icons/Github.svg" title="Github" alt="Github" />
                        <img src="src/assets/Icons/Selenium.svg" title="Selenium" alt="Selenium" />
                    </div>
                </div>
            </div>
        </section>
